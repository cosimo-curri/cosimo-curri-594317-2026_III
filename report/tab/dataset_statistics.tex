\begin{table*}[t]
	\centering
	\caption{Dataset statistics computed from the preprocessed datasets before the final resize. Luminance values are reported as mean $\pm$ standard deviation across samples. Dark pixels denote the average fraction of input pixels with luminance below $0.10$.}
