...
\subsection{Overview of the Implemented Workflow}
...
In addition to producing the preprocessed images and updated manifests, the script computes simple dataset-level statistics. These statistics are computed before applying the final resize, after loading the image with the correct orientation and converting it to RGB. Therefore, they summarize the illumination properties of the original images rather than only the $256 \times 256$ images later used as model inputs.
